...
?>                        
        ...
        <div class="row">
            <div class="col-xs-4 visible-xs-block photo un-un blue">
...
?>
             <div class="col-xs-4 col-sm-2 gris-2 un-un">
               <div class="bloc-text">
                ...
                <a class="icone-link" href="<?php $pdfdownload_dir . $fiche->file_name() ?>" target="_blank"><i class="fas fa-arrow-right"></i></a>
            </div>
<?php
        }
    }
...
?>                            
 ...
 <?php
  if (empty($documents))
  {
      echo('Aucun document pour cette copropriété');   
  }
  else
  {
?>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?= $category->position() ?>">Documents <?= $category->name() ?>s</a>
                                </h4>
                            </div>
