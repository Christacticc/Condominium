...
?>
    ...
    <section class="main">
		<div class="container-fluid"<?= $photos[0] ? ' style="background-image: url(\'' . $phodownload_dir . $photos[0]->file_name() . '\'); background-size:cover; background-position: 50%; background-repeat: no-repeat"' : '' ?>>
			<div class="container">
				<div class="row">
